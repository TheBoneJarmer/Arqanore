...
namespace Seanuts
{
    public class FontData
    {
        ...
        public FontData(string fontFamily, float fontSize, int r, int g, int b, int a) : this()
        {
            ...
            Font = new System.Drawing.Font(fontFamily, fontSize, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Pixel);
            Bitmap = new System.Drawing.Bitmap(GlyphSize * GlyphsHor, GlyphSize * GlyphsVert);
        ...
        public void GenerateBitmap()
        {
            ...
            for (var i = 0; i < Bounds.Length; i++)
            {
                ...
                var point = new System.Drawing.PointF(x * GlyphSize, y * GlyphSize);

                grp.DrawString(chr.ToString(), Font, brush, point, System.Drawing.StringFormat.GenericTypographic);
            }
        }
        public void GenerateBounds()
        {
            for (var i = 0; i < Bounds.Length; i++)
            {
                ...
                if (i == 32)
                {
                    Bounds[i] = new Rectangle(0, 0, Font.Size / 2f, 0);
                    continue;
                }
