...
namespace Seanuts.Math
{
    public static class SNMath
    {
        ...
        public static float RadiansBetweenVectors(SNVector2 v1, SNVector2 v2)
        {
        ...
        public static float DegreesBetweenVectors(SNVector2 v1, SNVector2 v2)
        {
        ...
        public static float DistanceBetweenVectors(SNVector2 v1, SNVector2 v2)
        {
