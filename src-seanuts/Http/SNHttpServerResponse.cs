...
{
    public class SNHttpServerResponse
    {
        ...
        public SNHttpServerResponse(Socket socket)
        {
            this.Version = SNHttpVersion.Http11;
        ...
        public void SendFile(string path)
        {
            ...
            // Send the file
            if (!Headers.Contains("Content-Type")) Headers.Add("Content-Type", SNHttpHelper.GetContentType(path));
