...
{
    public class SNWebSocketMessage
    {
        public byte[] Buffer { get; private set; }
        public string Message { get; private set; }
        public SNWebSocketMessageType Type { get; private set; }

        public SNWebSocketMessage(byte[] data)
        {
            this.Buffer = data;
        }
        public SNWebSocketMessage(string message, SNWebSocketMessageType type)
        {
        ...
        public void Decode()
        {
            ...
            Type = (SNWebSocketMessageType)opcode;
        }
