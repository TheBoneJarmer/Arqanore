...
namespace Seanuts.PathFinding
{
    ...
    /// to move a single cell to the left <see cref="SNMovementPatterns"/> for some predefined
    /// options.
    /// </summary>
    public struct SNOffset : IEquatable<SNOffset>
    {
        ...
        public bool Equals(SNOffset other)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is SNOffset && Equals((SNOffset)obj);
        }

        public static bool operator ==(SNOffset a, SNOffset b)
        {
            return a.Equals(b);
        }
        ...
        public static SNPosition operator +(SNOffset a, SNPosition b)
        {
        ...
        public static SNPosition operator +(SNPosition a, SNOffset b)
        {
            return new SNPosition(a.X + b.X, a.Y + b.Y);
        }
