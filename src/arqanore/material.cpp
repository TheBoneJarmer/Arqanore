...
arqanore::Material::Material(const std::string& name) : Material()
{
    this->name = name;
}

arqanore::Material::Material(const Material& material)
{
...
arqanore::Material& arqanore::Material::operator=(const Material& material)
{
    this->name = material.name;
    this->shininess = material.shininess;
    this->color = material.color;
