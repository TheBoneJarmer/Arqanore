...
namespace arqanore
{
    ...
    public:
        ...
        static void render_text(Window* window, Font* font, std::u16string text, Vector2 position, Vector2 scale, Color color, float spacing = 0.0f);
        static void render_text(Window* window, Font* font, std::string text, Vector2 position, Vector2 scale, Color color, float spacing = 0.0f);
